...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentSystemPromptPlaceholder: '添加提示词，例如：每天检查 PR 和测试失败，并生成一份周报。',
    agentSkills: '技能',
  ...
  en: {
    ...
    agentSystemPromptPlaceholder:
      'Add instructions, for example: check PR and test failures every day, then draft a weekly report.',
    agentSkills: 'Skills',
    agentSkillsHint:
