...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkOpenClawExecutionModeAuto: '自动（OpenClaw 沙箱）',
    coworkOpenClawExecutionModeAutoHint: '由 OpenClaw 自动决定何时进入沙箱（对应 non-main）',
    coworkOpenClawExecutionModeLocal: '本地运行（关闭 OpenClaw 沙箱）',
    coworkOpenClawExecutionModeLocalHint: '关闭 OpenClaw 沙箱，全部工具直接在本机执行',
    coworkOpenClawExecutionModeSandbox: '仅沙箱（OpenClaw）',
    coworkOpenClawExecutionModeSandboxHint: '强制 OpenClaw 使用沙箱执行（对应 all）',
    coworkOpenClawSandboxNotice: 'OpenClaw 沙箱依赖 Docker（或兼容的 docker CLI 运行时）。若缺失将报错：spawn docker ENOENT。',
  ...
  en: {
    ...
    coworkOpenClawExecutionModeAuto: 'Auto (OpenClaw sandbox)',
    coworkOpenClawExecutionModeAutoHint: 'Let OpenClaw decide when to sandbox tool execution (maps to non-main)',
    coworkOpenClawExecutionModeLocal: 'Local only (OpenClaw sandbox off)',
    coworkOpenClawExecutionModeLocalHint: 'Disable OpenClaw sandbox and run all tools directly on host',
    coworkOpenClawExecutionModeSandbox: 'Sandbox only (OpenClaw)',
    coworkOpenClawExecutionModeSandboxHint: 'Force OpenClaw to run in sandbox mode (maps to all)',
    coworkOpenClawSandboxNotice: 'OpenClaw sandbox requires Docker (or a docker-compatible CLI runtime). Missing docker will fail with: spawn docker ENOENT.',
    ...
    imSessionTimeout: 'Session Timeout (min)',
