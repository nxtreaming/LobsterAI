...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imPopoCredentialHint: '从 POPO 开发者后台获取 AppKey、AppSecret、Token 和 AES Key',
    imPopoGuideStep1: '在 POPO 开发者后台创建一个新的机器人应用',
    imPopoGuideStep2: '获取 AppKey、AppSecret 凭证，并配置 Webhook Token 和 AES Key',
  ...
  en: {
    ...
    imPopoCredentialHint: 'Get AppKey, AppSecret, Token and AES Key from the POPO Developer Portal',
    imPopoGuideStep1: 'Create a new bot application in the POPO Developer Portal',
    imPopoGuideStep2: 'Get AppKey, AppSecret credentials and configure Webhook Token and AES Key',
